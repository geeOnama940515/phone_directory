...
class ExecutiveBoardDetails extends StatefulWidget {
  User user;

  ExecutiveBoardDetails({this.user});

  @override
  State<StatefulWidget> createState() {
    return ExecutiveBoardDetailsState();
  }
}

class ExecutiveBoardDetailsState extends State<ExecutiveBoardDetails> {
