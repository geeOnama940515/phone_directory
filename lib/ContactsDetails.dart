...
class ContactsDetailsState extends State<ContactsDetails>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: FirebaseDatabase.instance.reference().child('area').child(widget.area).child(widget.keys).once(),
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          CircleAvatar(
                            child: IconButton(
                              icon: Icon(Icons.call,size: 30.0,),
                              onPressed: () {
                                setState(() {
                          ...
                          CircleAvatar(
                            child: IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  _launched=_makePhoneCall('sms:${widget.phone}');
                                });
                              },
                              color: Colors.deepOrange.shade100,
                            ),
